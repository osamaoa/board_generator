    ...
    const timeoutId = window.setTimeout(async () => {
      try {
        const response = await axios.post(`${API_BASE_URL}/render/ring-color-overlays`, {
          ...
          ring_color_knot_spread_mm: Math.max(1e-6, Number(config.ring_color_knot_spread_mm) || defaultConfig.ring_color_knot_spread_mm),
          ring_color_knot_stain_color: config.ring_color_knot_stain_color || defaultConfig.ring_color_knot_stain_color,
